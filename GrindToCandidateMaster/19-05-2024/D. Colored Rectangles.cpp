...
Tatsumaki Chan Love of my Life タツマキ ちゃんが 大好きです <3 <3 
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠟⠏⠁⠈⠀⠈⠁⠀⡠⠀⠉⢬⠙⣭⠛⡌⢋⠍⠀⠁⠀⣀⠀⠀⢀⡀⠀⠈⠀⢀⠀⠀⠀⡠⠄⠠⢀⡠⢀⢆⣠⢉⡤⢄⡀⡀⢀⠀⢀⠀⡀⢀⠀⠈⠉⠀⢉⠻⢹⡿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣫⠄⠀⠀⠀⠀⢠⠞⠀⠀⡀⢂⣀⡠⡡⠀⢁⠔⡡⠎⠐⠁⢀⠴⠋⠀⠀⠀⢀⠠⠐⠀⠤⠒⠒⢖⡳⢾⢷⣾⣶⣯⣼⢧⣳⣜⣲⣎⡔⢢⠀⠄⠂⠄⠢⠁⢀⠸⢯⣝⢻⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⡁⠀⠀⠀⠀⢠⠃⠀⠀⠄⣀⣨⠥⠤⢤⣠⠁⠀⠀⠀⠀⣀⠧⠂⠀⠀⣠⠄⠀⠄⡀⢒⡐⠌⣙⣮⣽⣻⣞⣷⣯⣿⣿⣿⣿⣿⣾⣿⣯⣧⣿⣾⣶⣌⣠⡈⠀⢄⡈⠈⠫⠻⠿⠿⠍⠉⠹⠛⠻⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣟⠳⠀⠀⠀⠀⢠⡇⠀⠀⣠⠞⣁⣠⢤⣀⠀⠉⣶⠀⠀⡴⠋⢁⡤⣲⠀⠉⡉⢤⣊⣶⡵⣾⣹⣷⣹⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⣟⣶⣭⡝⣛⠷⣦⣌⠙⢦⠀⠄⠀⠀⠀⡀⠀⠀⠐⣯⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
...
int main() {
    ...
    sort(bg(a)+1,end(a), greater<ll>());
    sort(bg(b)+1,end(b), greater<ll>());
    sort(bg(c)+1,end(c), greater<ll>());
    
    ll res = 0;
    for(int i=0; i<=n; i++) {
        for(int j=0; j<=m; j++) {
            for(int l=0; l<=k; l++) {
                chkmax(dp[i+1][j+1][l], dp[i][j][l]+a[i+1]*b[j+1]);
                chkmax(dp[i+1][j][l+1],dp[i][j][l]+a[i+1]*c[l+1]);
                chkmax(dp[i][j+1][l+1], dp[i][j][l]+b[j+1]*c[l+1]);
                chkmax(res, dp[i][j][l]);
            }
        }
    }
